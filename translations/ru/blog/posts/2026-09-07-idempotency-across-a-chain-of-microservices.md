...
<figcaption><span class="bdr-diagram__eyebrow">ИДЕЯ В СХЕМЕ</span><strong>Один ключ операции сохраняется при всех повторах</strong></figcaption>
...
<p class="bdr-diagram__caption">Каждый повтор должен сохранять исходную идентичность операции на всех переходах. Каждому сервису по-прежнему нужны своя область ключа и политика для уже выполняющейся операции.</p>
</figure>
<!-- /diagram:concept -->
