...
<figcaption><span class="bdr-diagram__eyebrow">ИДЕЯ В СХЕМЕ</span><strong>Передайте агенту полный контракт</strong></figcaption>
...
<p class="bdr-diagram__caption">Одна страница для агента объединяет импорты, сигнатуры, инварианты и примеры. Так меньше пробелов, которые модель иначе заполнила бы догадками.</p>
</figure>
<!-- /diagram:concept -->
