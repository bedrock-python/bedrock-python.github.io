...
- **Post:** `docs/blog/posts/2026-09-07-safe-grpc-retries.md`
- **Category:** Design
- **Idea:** Some status codes make the retry bet safe; two of them do not.
...
Subject: A status strip of sixteen cells laid flat, most filled flush with slate blocks, two holding raised terracotta blocks that stand proud of the surface. A lane leaves one raised cell and loops back three times into a service housing below, leaving three identical effect discs stamped on it where there should have been one.
