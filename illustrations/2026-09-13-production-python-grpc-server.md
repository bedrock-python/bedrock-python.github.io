# Preparing a Python gRPC server for production

- **Post:** `docs/blog/posts/2026-09-13-production-python-grpc-server.md`
- **Category:** Tutorials
- **Idea:** A six-line server versus the assembly you can actually run.
...
Subject: An exploded assembly: one small plain service housing at the centre, and around it six flat plates floating in their assembly positions along the isometric axes, each aligned to a face and joined to it by thin alignment guides. A pair of channel tubes plugs into its front socket. One plate, positioned in front of the housing like a shield, is terracotta.
