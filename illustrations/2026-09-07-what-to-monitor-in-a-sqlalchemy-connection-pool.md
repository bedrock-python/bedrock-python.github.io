...
- **Post:** `docs/blog/posts/2026-09-07-what-to-monitor-in-a-sqlalchemy-connection-pool.md`
- **Category:** Tutorials
- **Idea:** The number everyone dashboards is the one that says nothing.
...
Subject: Four flat panels standing in a row, each carrying a simple polyline trace of straight segments. The first trace is a dead flat line pinned to the top edge of its panel, unchanged end to end, and that panel is terracotta. The other three climb, step and spike sharply halfway along. Below them stands a connection pool rack of four rods, all withdrawn, with a queue of blocks waiting behind it.
