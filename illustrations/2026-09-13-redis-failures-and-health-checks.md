# Redis failures: health checks and service behavior

- **Post:** `docs/blog/posts/2026-09-13-redis-failures-and-health-checks.md`
- **Category:** Design
- **Idea:** The absent dependency is one thing; what to do without it is three different decisions.
...
Subject: One key-value rack drawn only as a thin dashed outline, empty inside, standing where a solid rack should be. Three lanes arrive at it from three separate service housings, each ending at its own small door plate: the top door stands open and its lane continues past, the other two are shut and their lanes stop. The open door is terracotta.
