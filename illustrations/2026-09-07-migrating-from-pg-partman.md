...
- **Post:** `docs/blog/posts/2026-09-07-migrating-from-pg-partman.md`
- **Category:** Tutorials
- **Idea:** Partitions are owned by their bounds, so an inherited tree is adopted where it stands.
...
Subject: One parent bar with partition slabs seated beneath it, visibly of two different makes: some with chamfered top edges, some square, yet all sitting exactly on the same grid of bounds marked along the bar. To one side, two small configuration cards lie face up, one being folded into the shape of the other. The newest slab at the right end is terracotta.
