...
- **Post:** `docs/blog/posts/2026-09-07-reliability-is-not-retry-3.md`
- **Category:** Design
- **Idea:** Retries are one lever among four, and the only one that adds load.
...
Subject: A control panel plate with four upright levers in a row: three at rest, the first pushed hard forward and terracotta. From the panel a bundle of lanes runs to a service housing, and under the pushed lever the bundle visibly triples in thickness before it arrives. The housing is already leaning under the strain.
