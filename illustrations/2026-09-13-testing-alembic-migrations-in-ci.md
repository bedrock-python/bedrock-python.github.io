...
- **Post:** `docs/blog/posts/2026-09-13-testing-alembic-migrations-in-ci.md`
- **Category:** Tutorials
- **Idea:** A revision history walked up, back and up again, with five checks planted along it.
...
- a migration history: a vertical stack of thin plates, each offset a little from the one below, joined by a ladder up one side
- a database drum: a squat cylinder with two thin bands near its top

Subject: A migration history of four plates rising left to right like a staircase, with a slim band running up them, curving back down and up again in a closed loop. Five short peg posts stand in sockets cut into the plates. One plate has a clean fracture across it and the peg standing there is terracotta; the descending part of the band stops short at that plate. A database drum stands beside the stack.
