# Why I extract Python service infrastructure into libraries

- **Post:** `docs/blog/posts/2026-09-13-why-bedrock-python-libraries.md`
- **Category:** Meta
- **Idea:** The same infrastructure code, rebuilt in every service, around a small product core.
...
Subject: Four service housings in a row, shown in cutaway. Inside each, the same ring of eleven small identical component blocks surrounds a tiny central core. The rings are identical in all four, repeated exactly; only the cores differ in shape, and only one core is terracotta. The repeated rings dominate the tiny cores visually.
