...
- **Post:** `docs/blog/posts/2026-09-07-publishing-to-pypi-without-api-tokens.md`
- **Category:** Tutorials
- **Idea:** A short-lived identity replaces a stored key.
...
Subject: A clean straight path from a merged block on the left to a sealed package cube on the right, passing through one upright gate. Presented to the gate is a thin badge chip held in a mechanical clip, terracotta and visibly slight. Below the path, lying flat and connected to nothing, a heavy key block with a broken ring.
