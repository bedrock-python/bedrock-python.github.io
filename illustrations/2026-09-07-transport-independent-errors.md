...
- **Post:** `docs/blog/posts/2026-09-07-transport-independent-errors.md`
- **Category:** Design
- **Idea:** One domain error, two transports, two correct shapes.
...
Subject: One faceted prism block standing at the centre of the frame. From two of its faces, short lanes lead to two clearly different receiving ports: a wide HTTP port plate on the left and a pair of channel tubes on the right. Each lane carries a shape cut to fit its own port, and both shapes are cut from the same prism. One facet of the prism is terracotta.
